...
function! s:suite.QfstatuslineText() abort "{{{
    ...
    call setqflist([
        \ {'lnum': 8, 'bufnr': l:buf_no, 'col': 0, 'valid': 1, 'vcol': 0, 'nr': -1, 'type': 'e', 'pattern': '', 'text': ' syntax error, unexpected tIDENTIFIER, expecting keyword_end'},
    ...
    call setqflist([
        \ {'lnum': 10, 'bufnr': l:buf_no, 'col': 0, 'valid': 1, 'vcol': 0, 'nr': -1, 'type': 'e', 'pattern': '', 'text': ' syntax error, unexpected tIDENTIFIER, expecting keyword_end'},
        \ {'lnum': 9,  'bufnr': l:buf_no, 'col': 0, 'valid': 1, 'vcol': 0, 'nr': -1, 'type': 'e', 'pattern': '', 'text': 'Parse error: syntax error, unexpected ''$requested'' (T_VARIABLE)'},
